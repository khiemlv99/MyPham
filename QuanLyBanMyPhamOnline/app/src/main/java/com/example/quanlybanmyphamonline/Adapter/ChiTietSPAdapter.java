    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("tensp",arrayList.get(position).getTenSanPham());
                intent.putExtra("giasp",arrayList.get(position).getGiasp());
                intent.putExtra("motasp",arrayList.get(position).getMota());
                intent.putExtra("hinh",arrayList.get(position).getHinhanh());
                intent.putExtra("maloaisp",arrayList.get(position).getMaLoai());
